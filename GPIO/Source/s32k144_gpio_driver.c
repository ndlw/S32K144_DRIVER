 ...
 * @return  Std_GPIO_Status    GPIO_E_OK if success, GPIO_E_NOT_OK if error
 */
Std_GPIO_Status GPIO_SetDirection(GPIO_Type *pGPIOx, ARM_GPIO_Pin_Type pin, ARM_GPIO_DIRECTION direction)
{
    Std_GPIO_Status result = GPIO_E_OK;
 ...
 * @return Std_GPIO_Status GPIO_E_OK if success, GPIO_E_NOT_OK if error
 */
Std_GPIO_Status GPIO_SetPin(GPIO_Type *pGPIOx, ARM_GPIO_Pin_Type pin)
{
    Std_GPIO_Status result = GPIO_E_OK;
 ...
 * @return Std_GPIO_Status GPIO_E_OK if success, GPIO_E_NOT_OK if error
 */
Std_GPIO_Status GPIO_ClearPin(GPIO_Type *pGPIOx, ARM_GPIO_Pin_Type pin)
{
    Std_GPIO_Status result = GPIO_E_OK;
 ...
 * @return Std_GPIO_Status GPIO_E_OK if success, GPIO_E_NOT_OK if error
 */
Std_GPIO_Status GPIO_TogglePin(GPIO_Type *pGPIOx, ARM_GPIO_Pin_Type pin)
{
    Std_GPIO_Status result = GPIO_E_OK;
