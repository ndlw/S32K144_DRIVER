...
typedef enum
{
    PORT_PIN_PULL_DISABLE = 0,
    PORT_PIN_PULL_ENABLE  = 1
...
{
    PORT_Pin_type pin;
    PORT_MUX_MODE_type mux;
    PORT_PULL_ENABLE_type pull_enable;
    PORT_PIN_PULL_MODE_type pull_select;
    PORT_IRQ_MODE_type irq_mode;
} PORT_Config_t;
